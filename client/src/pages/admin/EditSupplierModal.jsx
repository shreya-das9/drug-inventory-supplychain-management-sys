            ...
            >
              ...
              <div className="flex items-center justify-between p-6 border-b border-white/10">
                <div>
                  ...
                  <p className="text-sm text-white/50 mt-1">Update supplier information</p>
                </div>
                <motion.button
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-h-[60vh] overflow-y-auto pr-2 custom-scrollbar">
                  ...
                  <div className="md:col-span-2">
                    ...
                    <select
                      ...
                      onChange={handleChange}
                      className="w-full bg-white/5 text-white px-4 py-3 rounded-xl border border-white/10 focus:border-purple-500/50 focus:outline-none focus:ring-2 focus:ring-purple-500/20 transition-all cursor-pointer"
                    >
